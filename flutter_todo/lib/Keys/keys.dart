...
import 'package:flutter_todo/Keys/check_todo_items.dart';
          ...
          child: Column(
            children: [
              ...
              for (final todo in _orderedTodos)
                CheckableTodoItem(
                  // one way of adding key always remember to use the unique key value id would be greater
                  key: ValueKey(todo.text),

                  // another way not preferable because valueKey is more light weight
                  // key:  ObjectKey(todo),
                  todo.text,
                  todo.priority,
                ),
