...
class MealDetailsScreens extends ConsumerWidget {
  const MealDetailsScreens({required this.meal, super.key});
  final Meal meal;
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            onPressed: () {
           final wasAdded =   ref.read(favoriteMealsProvider.notifier).toogleMealFavoriteStatus(meal);
